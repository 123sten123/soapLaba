 ...
 * 
 */
@WebServiceClient(name = "HelloWorldImplService", targetNamespace = "http://soap.test.com/", wsdlLocation = "http://localhost:8081/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDIMPLSERVICE_QNAME = new QName("http://soap.test.com/", "HelloWorldImplService");
    ...
    public HelloWorld getHelloWorldImplPort() {
        return super.getPort(new QName("http://soap.test.com/", "HelloWorldImplPort"), HelloWorld.class);
    }
    ...
    public HelloWorld getHelloWorldImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://soap.test.com/", "HelloWorldImplPort"), HelloWorld.class, features);
    }
